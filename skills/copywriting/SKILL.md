---
name: copywriting
description: Write or revise product copy including website text, UI labels, errors, empty states, and onboarding. Use when writing headlines, landing pages, button labels, error messages, or tooltips.
---
...
1. **See the string in context** — which screen, where in the flow, what the user is trying to do at that moment.
2. **Draft 2–3 options** for high-stakes strings (headlines, CTAs, error messages); one is enough for trivial labels.
3. **Show in context**, not as a bare list — mock up the sentence or screen around the string.
4. **Read it aloud.** If it sounds stiff spoken, rewrite it.
